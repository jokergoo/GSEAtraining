...
In the previous code, we use the function `toTable()` to retrieve the data as data frames. You can also try `as.list()` on the two objects and compare the output.
...
Pathways more more than 2000 genes:
